    ...
    public static void main(String []args) throws JMSException {
        ...
        while(true) {
            ...
            if( msg instanceof  ObjectMessage ) {
            	...
            	//TODO: Se verifica que el objeto es del tipo de la clase serializable
            	if(((ObjectMessage) msg).getObject() instanceof /*clase*/ ){
            		
            		//TODO: Casting del objeto recibido a una instancia de la clase
            		
            		/*Clase*/ body = (/*Clase*/)((ObjectMessage) msg).getObject();
